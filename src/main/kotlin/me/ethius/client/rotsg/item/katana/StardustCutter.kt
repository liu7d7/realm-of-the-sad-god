...
class StardustCutter:KatanaItem(TexData.stardust_cutter,
    ...
    companion object {
        ...
        private val entityInfo =
            ProjectileProperties(TexData.cutter_proj, 0.35, 0.2, 13.0, 4.2, true, false, false, false, 160..260).also { it.renderAngleAdd = ProjectileProperties.slant_angle_correction }
    }
